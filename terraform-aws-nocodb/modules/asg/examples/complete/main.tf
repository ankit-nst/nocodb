# IAM role and instance profile for EC2 to access Secrets Manager
resource "aws_iam_role" "ec2_secrets_manager" {
...
resource "aws_iam_role_policy_attachment" "ec2_secrets_manager" {
  role       = aws_iam_role.ec2_secrets_manager.name
  policy_arn = "arn:aws:iam::aws:policy/SecretsManagerReadWrite"
}

resource "aws_iam_instance_profile" "ec2_secrets_manager" {
